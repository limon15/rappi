...
def validar_opcion_ingresada(opcion, opcion_maxima):
    if (opcion.isdigit() and 0<=int(opcion)<=opcion_maxima):
        opcion_correcta = True
    else:
        opcion_correcta = False
        print("El dato ingresado no es válido. Ingrese un número entero entre los valores listados.")
...
def devolver_opcion_elegida_validada(lista_opciones):
    opcion_valida = False
